...
class API {
  ...
  async getUserLoops(token, page = 1, limit = 6) {
    try {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "verification-form", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "verification-timer", children: timeLeft > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "Код истечет через: ",
        formatTime(timeLeft)
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#dc3545" }, children: "Код истек. Отправьте новый." }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "resend-section", style: { marginTop: "20px", textAlign: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          children: canResend ? "📧 Отправить код повторно" : `Повторная отправка через ${formatTime(timeLeft)}`
        }
      ) })
    ] })
  ] });
...
const LoginForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (errorMessage.includes("код верификации") || errorMessage.includes("verification") || errorMessage.includes("verify")) {
        console.log("✅ Server requires verification (detected from error message)");
        setVerificationEmail(credentials.username);
        setShowVerification(true);
  ...
  const handleVerificationSuccess = async (token, user) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        "showVerification: ",
        showVerification ? "✅ YES" : "❌ NO"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        "email: ",
        verificationEmail || "не задан"
      ] })
    ] }),
    showVerification ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      VerificationForm,
      {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "auth-note", children: [
        "Нет аккаунта? ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/register", children: "Зарегистрироваться" })
      ] })
    ] })
  ] });
};
  ...
  const fetchLoops = async (pageNum = 1, append = false) => {
    try {
      ...
      if (type === "my" && token) {
        ...
        response = await api.getAllLoops(pageNum, limit, token || void 0);
...
const root = "_root_8bsdy_3";
const wrap = "_wrap_8bsdy_24";
const topRow = "_topRow_8bsdy_71";
const headline = "_headline_8bsdy_72";
...
const contactLink = "_contactLink_8bsdy_186";
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.ctaArrow, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "svg",
              {
                ...
                strokeLinejoin: "round",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "1.5", y1: "9.5", x2: "9.5", y2: "1.5" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("polyline", { points: "3.5,1.5 9.5,1.5 9.5,7.5" })
                ]
              }
            ) })
          ]
...
const homePage = "_homePage_1rzt5_7";
const promoSection = "_promoSection_1rzt5_21";
const promoNoise = "_promoNoise_1rzt5_33";
const promoOrb1 = "_promoOrb1_1rzt5_44";
const promoOrb2 = "_promoOrb2_1rzt5_57";
const promoInner = "_promoInner_1rzt5_76";
const promoLeft = "_promoLeft_1rzt5_94";
const promoBadge = "_promoBadge_1rzt5_101";
const promoBadgeDot = "_promoBadgeDot_1rzt5_119";
const promoTitle = "_promoTitle_1rzt5_134";
const promoTitleLine = "_promoTitleLine_1rzt5_146";
const promoTitleAccent = "_promoTitleAccent_1rzt5_150";
const promoSubtitle = "_promoSubtitle_1rzt5_157";
const promoButtons = "_promoButtons_1rzt5_168";
const promoPrimary = "_promoPrimary_1rzt5_176";
const promoSecondary = "_promoSecondary_1rzt5_201";
const promoStats = "_promoStats_1rzt5_224";
const promoStat = "_promoStat_1rzt5_224";
const promoStatNum = "_promoStatNum_1rzt5_237";
const promoStatLabel = "_promoStatLabel_1rzt5_245";
const promoStatDivider = "_promoStatDivider_1rzt5_253";
const promoRight = "_promoRight_1rzt5_261";
const floatingTag = "_floatingTag_1rzt5_270";
const floatingTagDot = "_floatingTagDot_1rzt5_295";
const playerCard = "_playerCard_1rzt5_305";
const playerTop = "_playerTop_1rzt5_320";
const playerCover = "_playerCover_1rzt5_327";
const playerCoverInner = "_playerCoverInner_1rzt5_340";
const playerMeta = "_playerMeta_1rzt5_348";
const playerName = "_playerName_1rzt5_353";
const playerSub = "_playerSub_1rzt5_363";
const playerGenre = "_playerGenre_1rzt5_368";
const playerWaveform = "_playerWaveform_1rzt5_382";
const playerBar = "_playerBar_1rzt5_391";
const playerFooter = "_playerFooter_1rzt5_410";
const playerControls = "_playerControls_1rzt5_416";
const playerBtnSm = "_playerBtnSm_1rzt5_422";
const playerBtnMain = "_playerBtnMain_1rzt5_441";
const playerDuration = "_playerDuration_1rzt5_460";
const activityCard = "_activityCard_1rzt5_468";
const activityTitle = "_activityTitle_1rzt5_482";
const activityBars = "_activityBars_1rzt5_491";
const activityBar = "_activityBar_1rzt5_491";
const activityFooter = "_activityFooter_1rzt5_513";
const activityOnline = "_activityOnline_1rzt5_519";
const activityDot = "_activityDot_1rzt5_528";
const activityCount = "_activityCount_1rzt5_537";
const homeSection = "_homeSection_1rzt5_546";
const sectionHeader = "_sectionHeader_1rzt5_553";
const sectionTitleWrapper = "_sectionTitleWrapper_1rzt5_557";
const sectionBadge = "_sectionBadge_1rzt5_561";
const sectionTitle = "_sectionTitle_1rzt5_557";
const titleAccent = "_titleAccent_1rzt5_585";
const sectionDescription = "_sectionDescription_1rzt5_589";
const featuresEnhancedSection = "_featuresEnhancedSection_1rzt5_601";
const featuresBgGlow = "_featuresBgGlow_1rzt5_609";
const featuresGridPattern = "_featuresGridPattern_1rzt5_617";
const badgeIcon = "_badgeIcon_1rzt5_629";
const featuresGridEnhanced = "_featuresGridEnhanced_1rzt5_635";
const featureCardEnhanced = "_featureCardEnhanced_1rzt5_644";
const featureCardGlow = "_featureCardGlow_1rzt5_665";
const featureIconWrapper = "_featureIconWrapper_1rzt5_680";
const featureIconGlow = "_featureIconGlow_1rzt5_690";
const featureEmoji = "_featureEmoji_1rzt5_704";
const featureContent = "_featureContent_1rzt5_712";
const featureHeader = "_featureHeader_1rzt5_719";
const featureTitleEnhanced = "_featureTitleEnhanced_1rzt5_726";
const featureBadge = "_featureBadge_1rzt5_736";
const featureDescriptionEnhanced = "_featureDescriptionEnhanced_1rzt5_749";
const featureTags = "_featureTags_1rzt5_758";
const featureStats = "_featureStats_1rzt5_782";
const featureStatItem = "_featureStatItem_1rzt5_788";
const statValue = "_statValue_1rzt5_794";
const statLabel = "_statLabel_1rzt5_802";
const featureActivity = "_featureActivity_1rzt5_810";
const activityIndicator = "_activityIndicator_1rzt5_817";
const activityDotPulse = "_activityDotPulse_1rzt5_825";
const activityToday = "_activityToday_1rzt5_833";
const featureUploadInfo = "_featureUploadInfo_1rzt5_839";
const featuresBottomLine = "_featuresBottomLine_1rzt5_854";
const homeCta = "_homeCta_1rzt5_1015";
const ctaActions = "_ctaActions_1rzt5_1020";
const styles = {
	homePage: homePage,
	...
	promoOrb1: promoOrb1,
	promoOrb2: promoOrb2,
	promoInner: promoInner,
	promoLeft: promoLeft,
	promoBadge: promoBadge,
	promoBadgeDot: promoBadgeDot,
	promoTitle: promoTitle,
	promoTitleLine: promoTitleLine,
	promoTitleAccent: promoTitleAccent,
	...
	promoStat: promoStat,
	promoStatNum: promoStatNum,
	promoStatLabel: promoStatLabel,
	promoStatDivider: promoStatDivider,
	promoRight: promoRight,
	floatingTag: floatingTag,
	floatingTagDot: floatingTagDot,
	playerCard: playerCard,
	playerTop: playerTop,
	playerCover: playerCover,
	playerCoverInner: playerCoverInner,
	...
	playerBtnSm: playerBtnSm,
	playerBtnMain: playerBtnMain,
	...
	featuresBgGlow: featuresBgGlow,
	featuresGridPattern: featuresGridPattern,
	badgeIcon: badgeIcon,
	featuresGridEnhanced: featuresGridEnhanced,
	featureCardEnhanced: featureCardEnhanced,
	featureCardGlow: featureCardGlow,
	featureIconWrapper: featureIconWrapper,
	featureIconGlow: featureIconGlow,
	featureEmoji: featureEmoji,
	featureContent: featureContent,
	featureHeader: featureHeader,
	featureTitleEnhanced: featureTitleEnhanced,
	featureBadge: featureBadge,
	featureDescriptionEnhanced: featureDescriptionEnhanced,
	featureTags: featureTags,
	featureStats: featureStats,
	featureStatItem: featureStatItem,
	statValue: statValue,
	statLabel: statLabel,
	...
	featuresBottomLine: featuresBottomLine,
	homeCta: homeCta,
...
const Loops = () => {
  const [recentLimit, setRecentLimit] = reactExports.useState(8);
  const [subLimit, setSubLimit] = reactExports.useState(8);
...
const UserProfile = () => {
  ...
  const fetchUserLoops = async (targetUserId) => {
    try {
      setLoading(true);
      setError(null);
      const userResponse = await fetch(`https://loopera-lpr.vercel.app/api/chats/user/${targetUserId}`, {
...
const Search = () => {
  ...
  const fetchTags = async () => {
    try {
      const response = await api.getAllLoops(1, 1e3, token || void 0);
...
const ForgotPasswordForm = ({ onBack }) => {
  ...
  const [isCodeSent, setIsCodeSent] = reactExports.useState(false);
  const handleSubmit = async (e) => {
    e.preventDefault();
    setIsLoading(true);
    setMessage("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    ...
    !isCodeSent ? /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: isLoading ? "⏳ Отправка..." : "📧 Отправить код"
        }
      )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
        ...
        borderRadius: "6px",
        marginBottom: "15px"
      }, children: "✅ Код отправлен!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { color: "#666", fontSize: "14px" }, children: [
        "Проверьте вашу почту ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: email }),
        " и введите код из письма."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#666", fontSize: "12px", marginTop: "10px" }, children: 'Если письмо не пришло в течение 5 минут, проверьте папку "Спам".' })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center", marginTop: "20px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        onClick: onBack,
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AuthProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/forgot-password", element: /* @__PURE__ */ jsxRuntimeExports.jsx(ForgotPasswordForm, { onBack: () => window.history.back() }) }),
